...
export default function Robot(props) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/robot_playground/robot.gltf')
  const { animations: typingAnimation } = useGLTF('/robot_playground/robot.gltf')
...
useGLTF.preload('/playground/robot.gltf')
