...
export default function Robot_playground(props) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/robot_playground/robot_playground.glb')
  const { animations: typingAnimation } = useGLTF('/robot_playground/robot_playground.glb')
  const { actions } = useAnimations(typingAnimation, group);

  useEffect(() => {
    actions.Experiment.play() // Replace 'animationName' with the actual name of your animation
  }, [actions]);
...
useGLTF.preload('/robot_playground/robot_playground.glb')
